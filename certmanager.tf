##########
# Конфигурационный файл менеджера сертификатов (CM).
# Создает публичную зону, создает Let'sEncrypt сертификат и добавляет 
# CNAME запись для автоматизированного выпуска сертификатов
#
# Для работы CM требуется настроить у провайдера домена делегирование NS:
#   - ns1.yandexcloud.net
#   - ns2.yandexcloud.net
##########
